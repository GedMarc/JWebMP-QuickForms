 ...
 * @param <GROUP>
 */
public abstract class QForm<GROUP extends FormChildren, J extends QForm<GROUP, J>>
		extends DivSimple<J>
		implements IQForm<GROUP>
{
	...
	protected J setValue(Field field, Input input)
	{
		...
		{
			log.log(Level.WARNING, "Unable to access field : " + field.getName() + " in " + getObject().getClass(), e);
		}
		return (J) this;
	}
